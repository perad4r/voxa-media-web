...
<header class="site-header">
	<div class="site-header__inner">
		...
		<nav class="primary-nav" aria-label="<?php esc_attr_e('Điều hướng chính', 'voxa-media'); ?>">
			...
			<?php endif; ?>
			<button class="theme-toggle" type="button" data-theme-toggle aria-pressed="false" aria-label="<?php esc_attr_e('Chuyển sang chế độ tối', 'voxa-media'); ?>">
				<span class="theme-toggle__icon" data-theme-icon aria-hidden="true">☾</span>
				<span class="theme-toggle__label" data-theme-label><?php esc_html_e('TỐI', 'voxa-media'); ?></span>
			</button>
		</nav>
	</div>
</header>
